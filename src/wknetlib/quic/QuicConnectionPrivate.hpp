...
namespace wknet::quic
{
    ...
    struct QuicCommand final
    {
        ...
        ProtocolHeapArray<UCHAR, rtl::ProtocolAllocationSite::QuicCommandData> Data;
        ...
        ProtocolHeapArray<UCHAR, rtl::ProtocolAllocationSite::QuicCommandAuxiliaryData> AuxiliaryData;
    };
    ...
    class QuicConnection final
    {
      ...
      private:
        ...
        void NotifyWritableStreams() noexcept;
...
#endif
        ProtocolHeapArray<QuicCommand*, rtl::ProtocolAllocationSite::QuicCommandQueue> queue_;
        QuicCommand* deferredCommand_ = nullptr;
        ProtocolHeapArray<QuicStream*, rtl::ProtocolAllocationSite::QuicStreamTable> streams_;
        ProtocolHeapArray<QuicConnectionIdEntry, rtl::ProtocolAllocationSite::QuicLocalConnectionIdTable>
            localConnectionIds_;
        ProtocolHeapArray<QuicConnectionIdEntry, rtl::ProtocolAllocationSite::QuicPeerConnectionIdTable>
            peerConnectionIds_;
        ...
        bool applicationPacingPending_ = false;
        ...
        ProtocolHeapArray<char, rtl::ProtocolAllocationSite::QuicServerName> serverName_;
        ...
        ProtocolHeapArray<UCHAR, rtl::ProtocolAllocationSite::QuicReceiveBuffer> receiveBuffer_;
        ProtocolHeapArray<UCHAR, rtl::ProtocolAllocationSite::QuicPacketBuffer> packetBuffer_;
        ProtocolHeapArray<QuicPacketHeader, rtl::ProtocolAllocationSite::QuicPacketScratch> packetHeaderScratch_;
        ProtocolHeapArray<UCHAR, rtl::ProtocolAllocationSite::QuicDecryptBuffer> decryptBuffer_;
        ProtocolHeapArray<UCHAR, rtl::ProtocolAllocationSite::QuicFrameBuffer> frameBuffer_;
        ProtocolHeapArray<QuicFrame, rtl::ProtocolAllocationSite::QuicFrameScratch> frameParseScratch_;
        ProtocolHeapArray<UCHAR, rtl::ProtocolAllocationSite::QuicClientHelloBuffer> clientHelloBuffer_;
        ProtocolHeapArray<QuicAckRange, rtl::ProtocolAllocationSite::QuicAckRangeScratch> ackRangeScratch_;
        ...
        ULONGLONG receiveKeyPhaseStartPacketNumber_ = 0;
