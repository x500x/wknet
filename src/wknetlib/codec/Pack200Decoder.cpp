#include "Pack200Decoder.h"
#include "codec/ContentCoding.h"
#include "Pack200BandCodec.h"
#include "Pack200BandParser.h"
#include "Pack200Bands.h"
#include "Pack200ClassWriter.h"
#include "Pack200Codec.h"
#include "Pack200JarWriter.h"
    ...
    SIZE_T* decodedLength) noexcept
{
    ...
    *decodedLength = 0;
    ...
    if (IsGzipMagic(source, sourceLength)) {
        ...
        NTSTATUS status = ContentCoding::DecodeOne(
            Coding::Gzip,
