...
│   ├── transport/                    # ITransport、WSK/TLS、代理 CONNECT
│   ├── http1/ / http2/ / ws/        # 协议层
...
- 📚 **[项目 Wiki](https://github.com/x500x/khttp/wiki)** — 能力账本、架构、HTTP/1.1、HTTP/2 & HPACK、WebSocket、TLS 与证书、密码学、产品 API、传输层、连接池、异步、内存、NTSTATUS、Cookbook、FAQ、路线图、术语表等。
