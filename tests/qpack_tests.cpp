...
namespace
{
    ...
    void TestFailureInjection()
    {
        ...
        constexpr wknet::rtl::ProtocolAllocationSite tableSites[] = {
            wknet::rtl::ProtocolAllocationSite::QpackDynamicTableData,
            wknet::rtl::ProtocolAllocationSite::QpackDynamicTableEntries};
        for (const auto site : tableSites)
        {
            wknet::rtl::ProtocolFailureInjectionSetFailOnNth(site, 1);
            wknet::qpack::QpackDynamicTable table;
            Expect(table.Initialize(128, 64) == STATUS_INSUFFICIENT_RESOURCES,
                   "QPACK dynamic table failpoint is propagated");
            Expect(wknet::rtl::ProtocolFailureInjectionLiveCount(site) == 0 &&
                       wknet::rtl::ProtocolFailureInjectionLiveCount(
                           wknet::rtl::ProtocolAllocationSite::QpackDynamicTableData) == 0,
                   "partial QPACK table initialization releases tracked storage");
            wknet::rtl::ProtocolFailureInjectionSetFailOnNth(site, 0);
        }

        wknet::qpack::QpackEncoder encoder;
        Expect(NT_SUCCESS(encoder.Initialize(0, 0)), "failure-injection encoder initializes");
        const wknet::qpack::QpackFieldView field = {View("x-failpoint"), View("value"), false};
        UCHAR section[128] = {};
        SIZE_T sectionLength = 0;
        ULONGLONG applicationError = 0;

        wknet::rtl::ProtocolFailureInjectionSetFailOnNth(wknet::rtl::ProtocolAllocationSite::QpackEncoderFieldLines, 1);
        Expect(encoder.EncodeFieldSection(0, &field, 1, section, sizeof(section), &sectionLength, &applicationError) ==
                   STATUS_INSUFFICIENT_RESOURCES,
               "QPACK field-line failpoint is propagated");
        Expect(wknet::rtl::ProtocolFailureInjectionLiveCount(
                   wknet::rtl::ProtocolAllocationSite::QpackEncoderFieldLines) == 0,
               "failed QPACK field-line allocation has no live buffer");
        wknet::rtl::ProtocolFailureInjectionSetFailOnNth(wknet::rtl::ProtocolAllocationSite::QpackEncoderFieldLines, 0);

        wknet::rtl::ProtocolFailureInjectionSetFailOnNth(wknet::rtl::ProtocolAllocationSite::QpackEncoderReferences, 1);
        Expect(encoder.EncodeFieldSection(0, &field, 1, section, sizeof(section), &sectionLength, &applicationError) ==
                   STATUS_INSUFFICIENT_RESOURCES,
               "QPACK reference-list failpoint is propagated");
        Expect(wknet::rtl::ProtocolFailureInjectionLiveCount(
                   wknet::rtl::ProtocolAllocationSite::QpackEncoderFieldLines) == 0 &&
                   wknet::rtl::ProtocolFailureInjectionLiveCount(
                       wknet::rtl::ProtocolAllocationSite::QpackEncoderReferences) == 0,
               "partial QPACK encode releases temporary buffers");
        wknet::rtl::ProtocolFailureInjectionSetFailOnNth(wknet::rtl::ProtocolAllocationSite::QpackEncoderReferences, 0);

        wknet::qpack::QpackDynamicTable duplicateTable;
        Expect(NT_SUCCESS(duplicateTable.Initialize(128)) && NT_SUCCESS(duplicateTable.SetCapacity(128)) &&
                   NT_SUCCESS(duplicateTable.Insert(View("copy").Data, 4, View("value").Data, 5)),
               "QPACK duplicate failpoint fixture initializes");
        wknet::rtl::ProtocolFailureInjectionSetFailOnNth(wknet::rtl::ProtocolAllocationSite::QpackDynamicEntryCopy, 1);
        Expect(duplicateTable.DuplicateRelative(0) == STATUS_INSUFFICIENT_RESOURCES,
               "QPACK duplicate-copy failpoint is propagated");
        Expect(wknet::rtl::ProtocolFailureInjectionLiveCount(
                   wknet::rtl::ProtocolAllocationSite::QpackDynamicEntryCopy) == 0,
               "failed QPACK duplicate copy leaves no live buffer");
        wknet::rtl::ProtocolFailureInjectionSetFailOnNth(wknet::rtl::ProtocolAllocationSite::QpackDynamicEntryCopy, 0);

        wknet::qpack::QpackEncoder dynamicEncoder;
        ...
        Expect(NT_SUCCESS(dynamicEncoder.Initialize(128, 1)) &&
                   NT_SUCCESS(dynamicEncoder.SetCapacity(128, capacityInstruction, sizeof(capacityInstruction),
                                                         &capacityInstructionLength)) &&
                   NT_SUCCESS(dynamicEncoder.InsertWithLiteralName(
                       View("tracked").Data, 7, false, View("entry").Data, 5, false, insertInstruction,
                       sizeof(insertInstruction), &insertInstructionLength)),
               "QPACK outstanding-section failpoint fixture initializes");
        const wknet::qpack::QpackFieldView dynamicField = {View("tracked"), View("entry"), false};
        wknet::rtl::ProtocolFailureInjectionSetFailOnNth(
            wknet::rtl::ProtocolAllocationSite::QpackEncoderOutstandingSection, 1);
        Expect(dynamicEncoder.EncodeFieldSection(4, &dynamicField, 1, section, sizeof(section), &sectionLength,
                                                 &applicationError) == STATUS_INSUFFICIENT_RESOURCES,
               "QPACK outstanding-section failpoint is propagated");
        Expect(wknet::rtl::ProtocolFailureInjectionLiveCount(
                   wknet::rtl::ProtocolAllocationSite::QpackEncoderOutstandingSection) == 0 &&
                   wknet::rtl::ProtocolFailureInjectionLiveCount(
                       wknet::rtl::ProtocolAllocationSite::QpackEncoderFieldLines) == 0 &&
                   wknet::rtl::ProtocolFailureInjectionLiveCount(
                       wknet::rtl::ProtocolAllocationSite::QpackEncoderReferences) == 0,
               "failed QPACK outstanding-section tracking releases temporary buffers");
        wknet::rtl::ProtocolFailureInjectionSetFailOnNth(
            wknet::rtl::ProtocolAllocationSite::QpackEncoderOutstandingSection, 0);

        wknet::qpack::QpackDecoder huffmanDecoder;
        SIZE_T consumed = 0;
        Expect(NT_SUCCESS(huffmanDecoder.Initialize(128, 1, 256, 8)) &&
                   NT_SUCCESS(huffmanDecoder.ProcessEncoderInstructions(capacityInstruction, capacityInstructionLength,
                                                                        &consumed, &applicationError)) &&
                   NT_SUCCESS(dynamicEncoder.InsertWithLiteralName(
                       View("huffman").Data, 7, true, View("decoded").Data, 7, true, insertInstruction,
                       sizeof(insertInstruction), &insertInstructionLength)),
               "QPACK Huffman decoder failpoint fixture initializes");
        wknet::rtl::ProtocolFailureInjectionSetFailOnNth(wknet::rtl::ProtocolAllocationSite::QpackDecoderValue, 1);
        Expect(huffmanDecoder.ProcessEncoderInstructions(insertInstruction, insertInstructionLength, &consumed,
                                                         &applicationError) == STATUS_INSUFFICIENT_RESOURCES,
               "QPACK decoded-value failpoint is propagated");
        Expect(wknet::rtl::ProtocolFailureInjectionLiveCount(wknet::rtl::ProtocolAllocationSite::QpackDecoderValue) ==
                   0,
               "failed QPACK decoded value leaves no live buffer");
        wknet::rtl::ProtocolFailureInjectionSetFailOnNth(wknet::rtl::ProtocolAllocationSite::QpackDecoderValue, 0);

        wknet::qpack::QpackEncoder blockedEncoder;
        wknet::qpack::QpackDecoder blockedDecoder;
        Expect(NT_SUCCESS(blockedEncoder.Initialize(128, 1)) && NT_SUCCESS(blockedDecoder.Initialize(128, 1, 256, 8)) &&
                   NT_SUCCESS(blockedEncoder.SetCapacity(128, capacityInstruction, sizeof(capacityInstruction),
                                                         &capacityInstructionLength)) &&
                   NT_SUCCESS(blockedDecoder.ProcessEncoderInstructions(capacityInstruction, capacityInstructionLength,
                                                                        &consumed, &applicationError)) &&
                   NT_SUCCESS(blockedEncoder.InsertWithLiteralName(View("blocked").Data, 7, false, View("one").Data, 3,
                                                                   false, insertInstruction, sizeof(insertInstruction),
                                                                   &insertInstructionLength)),
               "QPACK blocked-section failpoint fixture initializes");
        const wknet::qpack::QpackFieldView blockedField = {View("blocked"), View("one"), false};
        Expect(NT_SUCCESS(blockedEncoder.EncodeFieldSection(8, &blockedField, 1, section, sizeof(section),
                                                            &sectionLength, &applicationError)),
               "QPACK blocked-section fixture encodes a future dynamic reference");
        wknet::qpack::QpackFieldView decodedFields[2] = {};
        UCHAR fieldBuffer[64] = {};
        UCHAR decoderInstruction[16] = {};
        SIZE_T fieldCount = 0;
        SIZE_T fieldBufferUsed = 0;
        SIZE_T decoderInstructionLength = 0;
        wknet::rtl::ProtocolFailureInjectionSetFailOnNth(wknet::rtl::ProtocolAllocationSite::QpackDecoderBlockedSection,
                                                         1);
        Expect(blockedDecoder.DecodeFieldSection(8, section, sectionLength, decodedFields, 2, &fieldCount, fieldBuffer,
                                                 sizeof(fieldBuffer), &fieldBufferUsed, decoderInstruction,
                                                 sizeof(decoderInstruction), &decoderInstructionLength,
                                                 &applicationError) == STATUS_INSUFFICIENT_RESOURCES,
               "QPACK blocked-section failpoint is propagated");
        Expect(wknet::rtl::ProtocolFailureInjectionLiveCount(
                   wknet::rtl::ProtocolAllocationSite::QpackDecoderBlockedSection) == 0,
               "failed QPACK blocked section leaves no live buffer");
        wknet::rtl::ProtocolFailureInjectionSetFailOnNth(wknet::rtl::ProtocolAllocationSite::QpackDecoderBlockedSection,
                                                         0);
    }
    ...
    void TestDynamicTable()
    {
        ...
        Expect(NT_SUCCESS(table.LookupAbsolute(duplicate, &entry)) && Equals(entry.Name, "d") &&
                   Equals(entry.Value, "4"),
    ...
    void TestInstructionStreamsAndFieldSections()
    {
        ...
        Expect(NT_SUCCESS(
                   decoder.ProcessEncoderInstructions(instruction, instructionLength, &consumed, &applicationError)) &&
        ...
        Expect(NT_SUCCESS(encoder.InsertWithLiteralName(View("x-test").Data, View("x-test").Length, true,
                                                        View("one").Data, View("one").Length, true, instruction,
                                                        sizeof(instruction), &instructionLength, &literalIndex)),
        ...
        Expect(NT_SUCCESS(encoder.InsertWithNameReference(false, 0, View("two").Data, View("two").Length, false,
        ...
        Expect(NT_SUCCESS(encoder.EncodeFieldSection(4, fields, 4, fieldSection, sizeof(fieldSection),
        ...
        Expect(NT_SUCCESS(decoder.DecodeFieldSection(4, fieldSection, fieldSectionLength, decodedFields, 5,
                                                     &decodedFieldCount, fieldBuffer, sizeof(fieldBuffer),
                                                     &fieldBufferUsed, decoderInstruction, sizeof(decoderInstruction),
        ...
        applicationError = 0;
        Expect(encoder.ProcessDecoderInstructions(partialDecoderInstruction, sizeof(partialDecoderInstruction),
                                                  &consumed, &applicationError) == STATUS_MORE_PROCESSING_REQUIRED &&
                   consumed == 0 && applicationError == 0,
               "fragmented decoder instruction waits for continuation bytes without raising a stream error");
        Expect(
            QpackEncoder::IsSensitiveName(View("Authorization").Data, View("Authorization").Length) &&
    ...
    void TestRelativeAndPostBaseDecoding()
    {
        ...
        Expect(NT_SUCCESS(encoder.InsertWithLiteralName(View("first").Data, 5, false, View("1").Data, 1, false,
                                                        instruction, sizeof(instruction), &instructionLength)) &&
                   NT_SUCCESS(decoder.ProcessEncoderInstructions(instruction, instructionLength, &consumed, &error)),
        ...
        SIZE_T fieldBufferUsed = 0;
        SIZE_T decoderInstructionLength = 0;
        Expect(NT_SUCCESS(decoder.DecodeFieldSection(4, relativeSection, sizeof(relativeSection), fields, 2,
        ...
        Expect(NT_SUCCESS(decoder.DecodeFieldSection(8, postBaseSection, sizeof(postBaseSection), fields, 2,
                                                     &fieldCount, fieldBuffer, sizeof(fieldBuffer), &fieldBufferUsed,
                                                     decoderInstruction, sizeof(decoderInstruction),
                                                     &decoderInstructionLength, &error)) &&
                   fieldCount == 1 && Equals(fields[0].Name, "second"),
    ...
    void TestBlockedStreamsAndCancellation()
    {
        ...
        Expect(NT_SUCCESS(encoder.SetCapacity(128, capacityInstruction, sizeof(capacityInstruction),
                                              &capacityInstructionLength)) &&
                   NT_SUCCESS(decoder.ProcessEncoderInstructions(capacityInstruction, capacityInstructionLength,
                                                                 &consumed, &error)),
        ...
        SIZE_T sectionLength = 0;
        Expect(NT_SUCCESS(
                   encoder.EncodeFieldSection(4, &sourceField, 1, section, sizeof(section), &sectionLength, &error)),
        ...
        SIZE_T fieldBufferUsed = 0;
        SIZE_T decoderInstructionLength = 0;
        Expect(decoder.DecodeFieldSection(4, section, sectionLength, decoded, 2, &fieldCount, fieldBuffer,
                                          sizeof(fieldBuffer), &fieldBufferUsed, decoderInstruction,
                                          sizeof(decoderInstruction), &decoderInstructionLength,
        ...
        Expect(NT_SUCCESS(
                   decoder.ProcessEncoderInstructions(insertInstruction, insertInstructionLength, &consumed, &error)),
        ...
        Expect(NT_SUCCESS(
                   ...
                   NT_SUCCESS(encoder.EncodeFieldSection(20, &sourceField, 1, section, sizeof(section), &sectionLength,
                                                         &error)) &&
        ...
        Expect(NT_SUCCESS(QpackEncodeInteger(20, 0x40, 6, manualCancellation, sizeof(manualCancellation),
                   ...
                   NT_SUCCESS(encoder.ProcessDecoderInstructions(manualCancellation, manualCancellationLength,
                                                                 &consumed, &error)) &&
                   encoder.OutstandingSectionCount() == 0,
        ...
        Expect(NT_SUCCESS(
                   encoder.EncodeFieldSection(12, &sourceField, 1, section, sizeof(section), &sectionLength, &error)),
        ...
        Expect(NT_SUCCESS(decoder.CancelStream(12, decoderInstruction, sizeof(decoderInstruction),
                                               &decoderInstructionLength)) &&
    ...
    void TestCapacityDelayAndMalformedStreams()
    {
        ...
        Expect(NT_SUCCESS(synchronizedDecoder.Initialize(128, 1, 128, 4)) &&
                   NT_SUCCESS(synchronizedDecoder.ProcessEncoderInstructions(instruction, instructionLength, &consumed,
                                                                             &error)),
        ...
        SIZE_T fieldBufferUsed = 0;
        SIZE_T decoderInstructionLength = 0;
        Expect(NT_SUCCESS(synchronizedDecoder.DecodeFieldSection(4, section, sectionLength, decoded, 1, &fieldCount,
                                                                 fieldBuffer, sizeof(fieldBuffer), &fieldBufferUsed,
                                                                 decoderInstruction, sizeof(decoderInstruction),
                                                                 &decoderInstructionLength, &error)) &&
                   NT_SUCCESS(encoder.ProcessDecoderInstructions(decoderInstruction, decoderInstructionLength,
                                                                 &consumed, &error)),
        ...
        Expect(emptyDecoder.DecodeFieldSection(4, invalidFieldSection, sizeof(invalidFieldSection), invalidFields, 1,
                                               &fieldCount, fieldBuffer, sizeof(fieldBuffer), &fieldBufferUsed,
                                               decoderInstruction, sizeof(decoderInstruction),
                                               &decoderInstructionLength, &error) == STATUS_PENDING,
               "future Required Insert Count blocks instead of being decoded prematurely");
        Expect(emptyDecoder.CancelStream(4, decoderInstruction, sizeof(decoderInstruction),
                                         &decoderInstructionLength) == STATUS_SUCCESS,
